...
func (r *RouteStruct) Patch(path string, callFunc func(c *server.Context) error, middlewares ...func(c *server.Context, next http.HandlerFunc)) *Route {
    ...
    patchRoutes[perfix] = r.routeChain(handler).ServeHTTP
