...
func (r *RouteStruct) Put(path string, callFunc func(c *server.Context) error, middlewares ...func(c *server.Context, next http.HandlerFunc)) {
    ...
    putRoutes[r.perfix+path] = r.routeChain(handler).ServeHTTP
}